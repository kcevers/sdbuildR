...
[`simulate()`](https://rdrr.io/r/stats/simulate.html) produces an
interactive timeseries plot. See it run — and build the same model from
scratch — in the [**Get started
