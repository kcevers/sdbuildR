...
If you have set have set `return_sims = TRUE`, you can find the individual simulation runs in `sims$df`. These are in long format, containing the value of each variable for each time point in each simulation $i$ per condition $j$. 
