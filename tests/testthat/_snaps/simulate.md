# print.simulate_stockflow() snapshot: successful simulation
...
# print.simulate_stockflow() snapshot: named model
...
# print.simulate_stockflow() snapshot: failed simulation
