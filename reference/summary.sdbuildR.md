...
Object of class `summary_sdbuildR`. A flat named list with one entry per
check. Each entry contains a `problem` field (`"none"`, `"warning"`, or
`"error"`) and type-specific data fields.
